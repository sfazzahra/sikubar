...
class _ProfilePetugasPageState extends State<ProfilePetugasPage> {
  ...
  Future<void> _loadProfil() async {
    ...
    try {
      final res = await _api.getProfilPetugas();
  ...
  Future<void> _simpanProfil(String nama, String alamat, String noHp) async {
    try {
      final res = await _api.updateProfilPetugas({
        'name'  : nama,
        'alamat': alamat,
        'no_hp' : noHp,
      });
  ...
  Future<void> _gantiPassword(
    ...
    try {
      await _api.updateProfilPetugasPassword(lama, baru, konfirmasi);
                            ...
                            Container(
                              ...
                              child: Column(children: [
                                ...
                                Container(
                                  ...
                                  child: const Text('Petugas Aktif',
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontSize: 12,
