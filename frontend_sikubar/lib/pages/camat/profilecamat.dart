...
class ProfilCamatPage extends StatefulWidget {
  ...
  @override
  State<ProfilCamatPage> createState() => _ProfilCamatPageState();
}

class _ProfilCamatPageState extends State<ProfilCamatPage> {
  ...
  // ── HELPER: ambil string aman dari map ───────────────────────────────────
  ...
  Future<void> _loadProfil() async {
    ...
    try {
      final res = await _api.getProfilCamat();
  ...
  Future<void> _simpanProfil(String nama, String alamat, String noHp) async {
    try {
      final res = await _api.updateProfilCamat({
        'name'  : nama,
        'alamat': alamat,
        'no_hp' : noHp,
      });
  ...
  Future<void> _gantiPassword(
    ...
    try {
      await _api.updatePasswordCamat(lama, baru, konfirmasi);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                          ...
                          child: Column(children: [
                            Container(
                              ...
                              child: Column(children: [
                                ...
                                _profileItem(Icons.person_outline,       'Nama Lengkap', _str('name')),
                                _profileItem(Icons.email_outlined,        'Email',        _str('email')),
                                _profileItem(Icons.location_on_outlined,  'Alamat',       _str('alamat')),
                                _profileItem(Icons.phone_outlined,        'No HP',        _str('no_hp')),
      ...
      bottomNavigationBar: const BottomMenuCamat(currentIndex: 1),
    );
  }
    ...
    return Container(
      ...
      child: Row(children: [
        Container(
          ...
          child: Icon(icon, color: Color(0xFF2F80ED), size: 20),
        ),
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.pop(ctx);
                  _simpanProfil(namaCtrl.text, alamatCtrl.text, hpCtrl.text);
                },
      ...
      builder: (ctx) => Padding(
        ...
        child: Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            const SizedBox(height: 14),
            _modalInput(konfCtrl, 'Konfirmasi Password Baru', Icons.lock,         obscure: true),
            const SizedBox(height: 24),
            SizedBox(
              width: double.infinity,
              height: 52,
