...
class _ProfilCamatPageState extends State<ProfilCamatPage> {
  ...
  void _showEditModal() {
    final namaCtrl =
        TextEditingController(text: profil!['name']?.toString() ?? '');
    final alamatCtrl =
        TextEditingController(text: profil!['alamat']?.toString() ?? '');
    final hpCtrl =
        TextEditingController(text: profil!['no_hp']?.toString() ?? '');
              ...
              child: Column(
                ...
                children: [
                  ...
                  _modalInput(baruCtrl, 'Password Baru', Icons.lock_outline,
                      obscure: true),
                  const SizedBox(height: 12),
                  _modalInput(konfCtrl, 'Konfirmasi Password Baru',
                      Icons.lock_outline,
                      obscure: true),
                  const SizedBox(height: 22),
                  SizedBox(
