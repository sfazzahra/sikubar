...
class _AdminJenisSuratTabState extends State<AdminJenisSuratTab> {
  ...
  final syaratCtrl = TextEditingController(); // pisah titik koma
  final tujuanCtrl = TextEditingController(); // pisah titik koma
  ...
  void _isiFormEdit(Map<String, dynamic> js) {
    ...
    // Gabung kembali dengan titik koma saat edit
                ...
                if (showForm) ...[
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      ...
                      _inp(namaCtrl, 'Nama Jenis Surat',
                          Icons.description_outlined),
                      _inp(kodeCtrl, 'Kode (cth: BBM, KK)',
                          Icons.tag),
                      _inp(deskCtrl, 'Deskripsi',
                          Icons.info_outline),

                      // PERSYARATAN
                      _inp(syaratCtrl,
                          'Persyaratan (lebih dari 1 pisah titik koma)',
                          Icons.checklist),
                      _hint('Contoh: KTP; KK; Surat Permohonan'),

                      const SizedBox(height: 14),

                      // TUJUAN
                      _inp(tujuanCtrl,
                          'Tujuan Pengajuan (lebih dari 1 pisah titik koma)',
                          Icons.flag_outlined),
                      _hint('Contoh: Untuk usaha; Untuk nelayan; Lainnya'),
      ...
      child: Column(
        ...
        if (syarat.isNotEmpty) ...[
          ...
          Wrap(
            ...
            runSpacing: 4,
            children: syarat
                .map((s) => _chip(s, Colors.grey.shade100,
                    Colors.black54))
                .toList(),
          ),
        ],
          ...
          Expanded(
            child: OutlinedButton.icon(
              ...
              icon: const Icon(Icons.edit,
                  size: 16, color: Color(0xFF2F80ED)),
              label: const Text('Edit',
                  style:
                      TextStyle(color: Color(0xFF2F80ED))),
            ),
          ),
  ...
  Widget _inp(TextEditingController c, String label,
      IconData icon) {
    return Padding(
